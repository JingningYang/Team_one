...
In the boxplot, we can see several outliers in the first three groups and large amount of zero value. It's hard to figure a clear pattern in the first four groups, but later on, then number of fragments are increasing as the drying days increasing.  
