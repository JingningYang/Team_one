...
Log(Prob(COMMINUTED)/Prob(BUTTERFULY)) = 0.8269632 + 0.00216*Days
...
T-statistics for days in Log(Prob(COMMINUTED)/Prob(BUTTERFULY)) equals to |0.00216/0.002647403| = 0.8158939, which is lower than 2.  Then, the Days does not make any difference for log-odds of preferring COMMINUTED relative to BUTTERFULY

Log(Prob(non applicable)/Prob(BUTTERFULY)) = 1.5166589 - 0.0024548581*Days 
...
```{r}
tbl = table(bone$`WAKE HACKLE`, bone$`BONE HACKLE`) 
chisq.test(tbl) 
```
